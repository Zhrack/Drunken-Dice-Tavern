...
var arrowRegex = new RegExp(/-{1,2}>/, "g");
          ...
          return (tree, _file) => {
            visit2(tree, "blockquote", (node) => {
              ...
              if (match && match.input) {
                ...
                const titleNode = {
                  type: "paragraph",
                  children: restOfTitle.length === 0 ? [{ type: "text", value: titleContent + " " }] : restOfTitle
                };
...
var TableOfContents_default = /* @__PURE__ */ __name((opts) => {
  const layout = opts?.layout ?? defaultOptions9.layout;
...
var FileNode = class _FileNode {
  ...
  map(mapFn2) {
    mapFn2(this);
    this.children.forEach((child) => child.map(mapFn2));
  }
  /**
  ...
  sort(sortFn2) {
    ...
    this.children.forEach((e) => e.sort(sortFn2));
  }
};
    ...
    return /* @__PURE__ */ jsxs16("div", { class: `recent-notes ${displayClass ?? ""}`, children: [
      ...
      /* @__PURE__ */ jsx29("ul", { class: "recent-ul", children: pages.slice(0, opts.limit).map((page) => {
        ...
        return /* @__PURE__ */ jsx29("li", { class: "recent-li", children: /* @__PURE__ */ jsxs16("div", { class: "section", children: [
          ...
          /* @__PURE__ */ jsx29("ul", { class: "tags", children: tags.map((tag) => /* @__PURE__ */ jsx29("li", { children: /* @__PURE__ */ jsxs16(
            "a",
            {
              class: "internal tag-link",
              href: resolveRelative(fileData.slug, `tags/${tag}`),
...
var sortFn = /* @__PURE__ */ __name((a, b) => {
  if (!a.file && !b.file) {
...
var mapFn = /* @__PURE__ */ __name((node) => {
  if (node.depth > 0) {
    if (node.file) {
      node.displayName = "\u{1F4DD} " + node.displayName;
    } else {
