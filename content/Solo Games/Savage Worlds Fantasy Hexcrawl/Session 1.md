...
Our party, composed of a joke-cracking Dwarf Cleric of [[Tramadir|Tramadir]] named [[Drukmor|Drukmor]] and the grim Human Soldier [[Gultag|Gultag]], have accepted the mission from the Protectors to retrieve the airship. The only lead for now is the [[Red Arcanists Watchtower|Red Arcanists Watchtower]], where the group has been seen.  
